...
#
# Source0 file verified with key 0x6F7F0F91D138FC7B (dgg@incenp.org)
#
Name     : pinentry
Version  : 1.1.1
Release  : 28
URL      : https://gnupg.org/ftp/gcrypt/pinentry/pinentry-1.1.1.tar.bz2
Source0  : https://gnupg.org/ftp/gcrypt/pinentry/pinentry-1.1.1.tar.bz2
Source1  : https://gnupg.org/ftp/gcrypt/pinentry/pinentry-1.1.1.tar.bz2.sig
...
%prep
%setup -q -n pinentry-1.1.1
cd %{_builddir}/pinentry-1.1.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611598919
...
cp %{_builddir}/pinentry-1.1.1/COPYING %{buildroot}/usr/share/package-licenses/pinentry/2d29c273fda30310211bbf6a24127d589be09b6c
%make_install
