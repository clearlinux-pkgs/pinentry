...
Version  : 1.3.0
Release  : 33
URL      : https://gnupg.org/ftp/gcrypt/pinentry/pinentry-1.3.0.tar.bz2
Source0  : https://gnupg.org/ftp/gcrypt/pinentry/pinentry-1.3.0.tar.bz2
Source1  : https://gnupg.org/ftp/gcrypt/pinentry/pinentry-1.3.0.tar.bz2.sig
...
%prep
%setup -q -n pinentry-1.3.0
cd %{_builddir}/pinentry-1.3.0
%patch -P 1 -p1
pushd ..
cp -a pinentry-1.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710779329
